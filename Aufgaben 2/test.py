...
def Hallo(y):
    ...
    while Zahl != 0:
        ...
        for i in range(len(Zähler_Zeichen)):
            if Zähler_Zeichen[i] > 3:
                print(Zähler_Zeichen)
                Zeichen_Wert = 0
                Zeichen_Wert += Römische_Zeichen_Wert[
                    Römische_Zeichen.index(Römische_Zahl[Letztes_Zeichen(Römische_Zeichen[i + 1], Römische_Zahl)])]
